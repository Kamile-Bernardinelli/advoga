...
export default async function IncidenciaPage() {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <h1 className="text-2xl font-bold text-gray-900 mb-1">Incidência &amp; tendência por subtema</h1>
        ...
        <>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
            <div className="bg-white rounded-xl border border-gray-200 p-4 text-center">
              <div className="text-2xl font-bold text-gray-900">{linhas.length}</div>
              <div className="text-xs text-gray-500 mt-1">Subtemas cobrados</div>
            </div>
            <div className="bg-white rounded-xl border border-gray-200 p-4 text-center">
              <div className="text-2xl font-bold text-gray-900">{totalQuestoes}</div>
              <div className="text-xs text-gray-500 mt-1">Questões na janela</div>
            </div>
            <div className="bg-white rounded-xl border border-gray-200 p-4 text-center">
              <div className="text-2xl font-bold text-gray-900">{edicoes.length}</div>
              <div className="text-xs text-gray-500 mt-1">Edições</div>
            </div>
            <div className="bg-white rounded-xl border border-gray-200 p-4 text-center">
              <div className="text-2xl font-bold text-gray-500">→</div>
              <div className="text-xs text-gray-500 mt-1">Estável</div>
            </div>
          </div>
          ...
          <div>
            <h2 className="text-base font-semibold text-gray-800 mb-3">Ranking por subtema</h2>
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
              <table className="w-full text-sm">
                <thead className="bg-gray-50 border-b border-gray-100">
                  <tr>
                    <th className="text-right px-3 py-3 font-medium text-gray-600 w-10">#</th>
                    <th className="text-left px-3 py-3 font-medium text-gray-600">Subtema</th>
                    <th className="text-left px-3 py-3 font-medium text-gray-600 w-40">Incidência</th>
                    ...
                    <th className="text-right px-3 py-3 font-medium text-gray-600 w-20">Treinar</th>
                  </tr>
                </thead>
                <tbody>
                  {topTabela.map((l, i) => {
                    ...
                    return (
                      ...
                      >
                        <td className="px-3 py-3 text-right tabular-nums text-gray-400">{i + 1}</td>
                        <td className="px-3 py-3">
                          ...
                          <div className="text-xs text-gray-400">{l.materiaNome} ›</div>
                        </td>
                        <td className="px-3 py-3">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="tabular-nums text-gray-700 w-6 text-right">
                              {l.incidencia}
                            </span>
                          </div>
                        </td>
                        ...
                        <td className="px-3 py-3 text-right tabular-nums text-gray-500 hidden md:table-cell">
                          {l.disponiveis}
                        </td>
